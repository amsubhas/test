// ─── NexBot Voice Engine ──────────────────────────────────────────────────────
// Integrated into NexBot — no longer a separate "NEXA" module.
// Abstraction layer: swap voice providers without touching consuming code.
...
// ─── ElevenLabs Provider (activate by setting NEXT_PUBLIC_ELEVENLABS_KEY) ───
...
// ─── NexBot Voice Engine — picks best provider automatically ─────────────────
export class NexBotVoiceEngine {
  ...
  /** Queue text for speaking. Interrupts current speech by default. */
